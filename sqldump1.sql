...
--
-- Host: localhost
-- Generation Time: Jan 31, 2013 at 05:37 PM
...
--
-- Database: `a5020959_hb`
--
alter DATABASE `a5020959_hb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `a5020959_hb`;
...
-- Procedures
--
CREATE DEFINER=`root`@`localhost` PROCEDURE `add_complex`(IN `cname` VARCHAR(50), IN `caddr` TEXT)
	NO SQL
if(cname is not null && caddr is not null) 
THEN
INSERT INTO Complex(cname, caddr)
VALUES(cname, caddr);
END IF$$

CREATE DEFINER=`root`@`localhost` PROCEDURE `add_user`(IN `email` VARCHAR(24), IN `password` VARCHAR(100))
	MODIFIES SQL DATA
IF(email is not null && password is not null) THEN
...
INSERT INTO `Complex` (`CID`, `cname`, `caddr`) VALUES
(1, 'apapr', 'dd...222');
...
('def', 'a5020959_hb', 'Complex', 'CID', 1, NULL, 'NO', 'mediumint', NULL, NULL, 7, 0, NULL, NULL, 'mediumint(9)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'a5020959_hb', 'Complex', 'cname', 2, NULL, 'NO', 'char', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(50)', '', '', 'select,insert,update,references', ''),
('def', 'a5020959_hb', 'Complex', 'caddr', 3, NULL, 'YES', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', '', '', 'select,insert,update,references', ''),
('def', 'a5020959_hb', 'Residence', 'RID', 1, NULL, 'NO', 'mediumint', NULL, NULL, 7, 0, NULL, NULL, 'mediumint(9)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'a5020959_hb', 'Residence', 'rname', 2, NULL, 'NO', 'char', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'char(50)', '', '', 'select,insert,update,references', ''),
('def', 'a5020959_hb', 'User', 'ID', 1, NULL, 'NO', 'mediumint', NULL, NULL, 7, 0, NULL, NULL, 'mediumint(9)', 'PRI', 'auto_increment', 'select,insert,update,references', ''),
('def', 'a5020959_hb', 'User', 'email', 2, NULL, 'NO', 'varchar', 24, 24, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(24)', '', '', 'select,insert,update,references', ''),
('def', 'a5020959_hb', 'User', 'password', 3, NULL, 'NO', 'varchar', 200, 200, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(200)', '', '', 'select,insert,update,references', ''),
...
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '69'),
...
('INNODB_BUFFER_POOL_READ_REQUESTS', '3084'),
('INNODB_BUFFER_POOL_READS', '282'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '194'),
('INNODB_DATA_FSYNCS', '38'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '6803456'),
('INNODB_DATA_READS', '292'),
('INNODB_DATA_WRITES', '69'),
('INNODB_DATA_WRITTEN', '2283008'),
('INNODB_DBLWR_PAGES_WRITTEN', '69'),
('INNODB_DBLWR_WRITES', '9'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '25'),
...
('INNODB_PAGES_READ', '281'),
('INNODB_PAGES_WRITTEN', '69'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '24343'),
('UPTIME_SINCE_FLUSH_STATUS', '24343');
...
('READ_ONLY', 'OFF'),
('HOSTNAME', 'dhcp-137-112-118-39.wlan.rose-hulman.edu'),
...
('FLUSH_TIME', '0'),
('GENERAL_LOG_FILE', '/Applications/MAMP/db/mysql/dhcp-137-112-118-39.log'),
('QUERY_PREALLOC_SIZE', '8192'),
('PERFORMANCE_SCHEMA_MAX_COND_CLASSES', '80'),
('SLOW_QUERY_LOG', 'OFF'),
('AUTO_INCREMENT_INCREMENT', '1'),
('MAX_SEEKS_FOR_KEY', '18446744073709551615'),
('TMPDIR', '/var/folders/xy/tjntfphj43d32ngpt2t_x9kh0000gn/T/'),
('SQL_BIG_SELECTS', 'ON'),
('EXPIRE_LOGS_DAYS', '0'),
...
('SLOW_QUERY_LOG_FILE', '/Applications/MAMP/db/mysql/dhcp-137-112-118-39-slow.log'),
...
('SLAVE_LOAD_TMPDIR', '/var/folders/xy/tjntfphj43d32ngpt2t_x9kh0000gn/T/'),
...
('def', 'a5020959_hb', 'PRIMARY', 'def', 'a5020959_hb', 'Complex', 'CID', 1, NULL, NULL, NULL, NULL),
('def', 'a5020959_hb', 'PRIMARY', 'def', 'a5020959_hb', 'Residence', 'RID', 1, NULL, NULL, NULL, NULL),
('def', 'a5020959_hb', 'PRIMARY', 'def', 'a5020959_hb', 'User', 'ID', 1, NULL, NULL, NULL, NULL),
...
('def', 'a5020959_hb', 'add_complex', 1, 'IN', 'cname', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', 'PROCEDURE'),
('def', 'a5020959_hb', 'add_complex', 2, 'IN', 'caddr', 'text', 65535, 65535, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'text', 'PROCEDURE'),
('def', 'a5020959_hb', 'add_user', 1, 'IN', 'email', 'varchar', 24, 24, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(24)', 'PROCEDURE'),
('def', 'a5020959_hb', 'add_user', 2, 'IN', 'password', 'varchar', 100, 100, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(100)', 'PROCEDURE');
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2013-01-31 16:37:47', NULL, NULL, NULL, '', '', NULL),
('def', 'a5020959_hb', 'Complex', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 7340032, '2013-01-31 09:59:23', NULL, NULL, NULL, '', '', NULL),
('def', 'a5020959_hb', 'Residence', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 7340032, '2013-01-31 10:00:46', NULL, NULL, NULL, '', '', NULL),
('def', 'a5020959_hb', 'User', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 1, 16384, 16384, NULL, 0, 7340032, '2013-01-31 09:52:18', NULL, NULL, NULL, '', '', NULL),
...
('def', 'mysql', 'proc', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 412, 824, 281474976710655, 4096, 0, '2011-02-14 14:27:18', '2013-01-31 09:28:05', NULL, NULL, '', '', NULL),
...
(90, 'root', 'localhost', 'a5020959_hb', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`'),
(82, 'root', 'localhost', 'a5020959_hb', 'Sleep', 895, '', NULL),
(80, 'root', 'localhost', 'a5020959_hb', 'Sleep', 4439, '', NULL),
(79, 'root', 'localhost', 'a5020959_hb', 'Sleep', 910, '', NULL),
(60, 'root', 'localhost', 'a5020959_hb', 'Sleep', 3139, '', NULL),
(59, 'root', 'localhost', 'a5020959_hb', 'Sleep', 3919, '', NULL);
...
('add_complex', 'def', 'a5020959_hb', 'add_complex', 'PROCEDURE', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'SQL', 'if(cname is not null && caddr is not null) \r\nTHEN\r\nINSERT INTO Complex(cname, caddr)\r\nVALUES(cname, caddr);\r\nEND IF', NULL, NULL, 'SQL', 'NO', 'NO SQL', NULL, 'DEFINER', '2013-01-31 09:27:53', '2013-01-31 09:27:53', '', '', 'root@localhost', 'utf8', 'utf8_general_ci', 'latin1_swedish_ci'),
('add_user', 'def', 'a5020959_hb', 'add_user', 'PROCEDURE', '', NULL, NULL, NULL, NULL, NULL, NULL, NULL, 'SQL', 'IF(email is not null && password is not null) THEN\r\nINSERT INTO User(email, password)\r\nVALUES(email, password);\r\n\r\n\r\nEND IF', NULL, NULL, 'SQL', 'NO', 'MODIFIES SQL DATA', NULL, 'DEFINER', '2013-01-31 07:38:40', '2013-01-31 07:38:40', '', '', 'root@localhost', 'utf8', 'utf8_general_ci', 'latin1_swedish_ci');
...
('def', 'a5020959_hb', 'latin1', 'latin1_swedish_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '3147'),
('INNODB_BUFFER_POOL_READS', '282'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '194'),
('INNODB_DATA_FSYNCS', '38'),
...
('def', 'a5020959_hb', 'Complex', 0, 'a5020959_hb', 'PRIMARY', 1, 'CID', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
('def', 'a5020959_hb', 'Residence', 0, 'a5020959_hb', 'PRIMARY', 1, 'RID', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'a5020959_hb', 'User', 0, 'a5020959_hb', 'PRIMARY', 1, 'ID', 'A', 1, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'mysql', 'proc', 0, 'mysql', 'PRIMARY', 3, 'type', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2013-01-31 16:37:47', '2013-01-31 16:37:47', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2013-01-31 16:37:47', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'a5020959_hb', 'Complex', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 7340032, 2, '2013-01-31 09:59:23', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'a5020959_hb', 'Residence', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 7340032, 1, '2013-01-31 10:00:46', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'a5020959_hb', 'User', 'BASE TABLE', 'InnoDB', 10, 'Compact', 1, 16384, 16384, 0, 0, 7340032, 2, '2013-01-31 09:52:18', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
...
('def', 'mysql', 'proc', 'BASE TABLE', 'MyISAM', 10, 'Dynamic', 2, 412, 824, 281474976710655, 4096, 0, NULL, '2011-02-14 14:27:18', '2013-01-31 09:28:05', NULL, 'utf8_general_ci', NULL, '', 'Stored Procedures'),
...
('def', 'a5020959_hb', 'PRIMARY', 'a5020959_hb', 'Complex', 'PRIMARY KEY'),
('def', 'a5020959_hb', 'PRIMARY', 'a5020959_hb', 'Residence', 'PRIMARY KEY'),
('def', 'a5020959_hb', 'PRIMARY', 'a5020959_hb', 'User', 'PRIMARY KEY'),
...
('a5020959_hb', 'add_user', 'PROCEDURE', 'add_user', 'SQL', 'MODIFIES_SQL_DATA', 'NO', 'DEFINER', 0x494e2060656d61696c602056415243484152283234292c20494e206070617373776f72646020564152434841522831303029, '', 0x494628656d61696c206973206e6f74206e756c6c2026262070617373776f7264206973206e6f74206e756c6c29205448454e0d0a494e5345525420494e544f205573657228656d61696c2c2070617373776f7264290d0a56414c55455328656d61696c2c2070617373776f7264293b0d0a0d0a0d0a454e44204946, 'root@localhost', '2013-01-31 07:38:40', '2013-01-31 07:38:40', '', '', 'utf8', 'utf8_general_ci', 'latin1_swedish_ci', 0x494628656d61696c206973206e6f74206e756c6c2026262070617373776f7264206973206e6f74206e756c6c29205448454e0d0a494e5345525420494e544f205573657228656d61696c2c2070617373776f7264290d0a56414c55455328656d61696c2c2070617373776f7264293b0d0a0d0a0d0a454e44204946),
('a5020959_hb', 'add_complex', 'PROCEDURE', 'add_complex', 'SQL', 'NO_SQL', 'NO', 'DEFINER', 0x494e2060636e616d65602056415243484152283530292c20494e20606361646472602054455854, '', 0x696628636e616d65206973206e6f74206e756c6c202626206361646472206973206e6f74206e756c6c29200d0a5448454e0d0a494e5345525420494e544f20436f6d706c657828636e616d652c206361646472290d0a56414c55455328636e616d652c206361646472293b0d0a454e44204946, 'root@localhost', '2013-01-31 09:27:53', '2013-01-31 09:27:53', '', '', 'utf8', 'utf8_general_ci', 'latin1_swedish_ci', 0x696628636e616d65206973206e6f74206e756c6c202626206361646472206973206e6f74206e756c6c29200d0a5448454e0d0a494e5345525420494e544f20436f6d706c657828636e616d652c206361646472290d0a56414c55455328636e616d652c206361646472293b0d0a454e44204946);
