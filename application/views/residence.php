        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              <li class="nav-header">Search for Similar Properties:</li>
              <li class="active">
		<a href="#">Price</a></li>
              <li><a href="#">Size</a></li>
              <li><a href="#">Utilities</a></li>
              <li><a href="#">Amenities</a></li>
              <li><a href="#">Distance from School</a></li>
            </ul>
          </div><!--/.well -->
        </div><!--/span-->
        <div class="span9">
          <div class="hero-unit">
            ...
            <p>If it's an apartment, complex will be listed here</p>
	    <p>Housing Type (either Apartment or House</p>
	    <p>contact info for residence</p>
