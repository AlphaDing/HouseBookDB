...
<html lang="en">
  <head>
    ...
    body {
      padding-bottom: 40px;
      background-image: url("assets/img/pw_maze_white.png");
    }
  ...
  <body>
      ...
      <!-- Wrap the .navbar in .container to center it within the absolutely positioned parent. -->
        ...
        <div class="navbar navbar-inverse">
          <div class="navbar-inner">
            ...
            <a class="brand" href="#">House Book</a>
    ...
    <!-- Carouselecho base_url("blog/post/123ss");
    ================================================== -->
    <div id="myCarousel" class="carousel slide">
	<div class="container">
      <div class="carousel-inner">
        <div class="item active">
          <img src='http://www.noupe.com/wp-content/uploads/2009/10/grungy-retro.jpg' alt="">
          <div class="container">
            <div class="carousel-caption" >
              <h1>Hey there! This is our CSSE333 DB project!</h1>
              <p class="lead">I don't know what to type here but I kinda have to. Well, not really.</p>
              <a class="btn btn-large btn-primary" href="index.php/user/register"> Sign up today </a>
            </div>
          </div>
        </div>
        <div class="item">
